...
function Footer() {
    return(
        <footer className='p-6 pt-20 pb-10 flex flex-col gap-4'>
            <div className="first--wrapper p-4 flex flex-col gap-8 justify-center items-center">
                <div className="logo cursor-pointer">
                    <img src="./images/logo.svg" alt="" />
                </div>
                <div className="social--wrapper flex gap-4 items-center justify-center">
            ...
            <hr />
            <div className="second--wrapper p-4 flex flex-col gap-10 justify-center items-center text-center">
                <div className="list--wrapper flex flex-col gap-4">
                    <h5>Our company</h5>
                    <ul className="footer--link flex flex-col gap-1">
                        <li>how we work</li>
                        <li>way insure?</li>
                        <li>check price</li>
                        <li>reviews</li>
        ...
        <p className='mx-auto info'>Site Developed by <a href="https://github.com/">Abhishek Choudhary</a> </p>
        </footer>
    )
}
